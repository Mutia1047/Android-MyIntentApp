    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Mutiara Widdi Ayunintyas");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 19);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Mutiara Widdi Ayunintyas");
                mPerson.setAge(19);
                mPerson.setEmail("mutiewiddia@yahoo.co.id");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "081366446054";
